...
if ($reqName && $_REQUEST['QUAN']) {
    ...
    foreach ($rows as $row) {
        $createdFio = CUser::GetByID($row["CREATED_BY"])->Fetch()['LAST_NAME'];
        $responseFio = CUser::GetByID($row["RESPONSIBLE_ID"])->Fetch()['LAST_NAME'];
...
<p>Контроль стадии - Дожим в оплату</p>
<p>Провести контроль ожидания</p>
<p>Контроль стадии - Подбор оборудования 1</p>
<p>Контроль стадии - Согласовать с клиентом</p>
<p>Контроль стадии - Выставить счет</p>
