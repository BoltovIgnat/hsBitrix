...
<?$APPLICATION->IncludeComponent(
	...
	Array(
		...
		"G_VIDEO_IBLOCK_ID"=>"40",
		"G_VIDEO_PATH_TO_FILE"=>"209",
		"G_VIDEO_DURATION"=>"210",
		"G_VIDEO_SECTION_ID"=>"64",
		"G_VIDEO_ELEMENT_ID"=>"123",
		"G_VIDEO_WIDTH"=>"400",
		"G_VIDEO_HEIGHT"=>"300",
