...
$arUrlRewrite=array (
  ...
  array (
    ...
    'PATH' => '/extranet/pub/calendar_event.php',
    'SORT' => 100,
  ),
  5 => 
  array (
  ...
  182 => 
  array (
    'CONDITION' => '#^/extranet/pub/calendar-sharing/([0-9a-zA-Z]+)/?([^/]*)#',
    'RULE' => 'hash=$1',
    'ID' => 'bitrix:calendar.pub.sharing',
    'PATH' => '/extranet/pub/calendar_sharing.php',
    'SORT' => 100,
  ),
  78 => 
  array (
  ...
  188 => 
  array (
    'CONDITION' => '#^/extranet/pub/payment-slip/([\\w\\W]+)/#',
    'RULE' => 'signed_payment_id=$1',
    'ID' => 'bitrix:salescenter.pub.payment.slip',
    'PATH' => '/extranet/pub/payment_slip.php',
    'SORT' => 100,
  ),
  101 => 
  array (
  ...
  array (
    ...
    'RULE' => '',
    'ID' => 'bitrix:catalog.store.document.controller',
