...
if ($GLOBALS["USER"]->IsAuthorized())
{
        ...
        if (CModule::IncludeModule("intranet") && CIntranetUtils::IsExternalMailAvailable())
                $aMenuB24[] = Array(
                        ...
                        Array(),
                        Array("counter_id" => "mail_unseen", "warning_link" => SITE_DIR.'company/personal/mail/?config', "warning_title" => GetMessage("LEFT_MENU_MAIL_SETTING"), "menu_item_id"=>"menu_external$                        ""
                );
