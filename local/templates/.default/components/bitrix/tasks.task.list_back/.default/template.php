...
<!-- Hsfix start-->
<style>
	tr[data-color="skyblue"] td:nth-child(3){
		border-bottom:5px solid skyblue !important;
	} 
	tr[data-color="yellow"] td:nth-child(3){
		border-bottom:5px solid yellow !important;
	} 
	tr[data-color="orange"] td:nth-child(3){
		border-bottom:5px solid orange !important;
	} 
	tr[data-color="grey"] td:nth-child(3){
		border-bottom:5px solid grey !important;
	} 
	tr[data-color="violet"] td:nth-child(3){
		border-bottom:5px solid violet !important;
	} 
</style>
<!-- Hsfix end-->