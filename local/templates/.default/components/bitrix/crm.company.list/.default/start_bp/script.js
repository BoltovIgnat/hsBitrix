...
BX.StartBp = (function ()
{
	...
	StartBp.prototype.run = function(){
		...
		if(!button.length) {
			var timer = setInterval(function(){
				if(!$('.main-grid-action-panel').hasClass("main-grid-disable")) {
	...
	StartBp.prototype.GetButton = function() {
        return '<span class="main-grid-panel-control-container"><span class="main-grid-buttons" data-action="startbp-process" data-user="" title="Реанимация клиента">Реанимация клиента</span>';
    };
