...
BX.ControlRequireFields = (function ()
{
	...
	{
		this.params = {
			'SELECT_CODE': 'UF_CRM_1682374344942',
			'COMMENT_CODE': 'UF_CRM_1682374427255',
			'DATE_CODE': 'UF_CRM_1682374233977',
			'SELECT_VALUE_YES': '2332'
		};
		this.addEvent();
		//this.onCustomEvent();
	};
...
/* 			select.on('change', function() {
	...
	ControlRequireFields.prototype.change = function(frame, state){
		const comment = frame.find('input[name="'+this.params.COMMENT_CODE+'"]');
