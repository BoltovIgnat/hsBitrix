...
/*         BX.addCustomEvent("onPullEvent-hs_lead_detail", function(command,params,sys) {
    ...
    CheckFieldInn.prototype.showFields = function(field) {
        ...
        if (inn) {
            if (inn.length > 2) {
                if (inn?.length > 10) {
                    ...
                    $('div[data-cid="UF_CRM_1681060407887"]').show();
                    $('div[data-cid="UF_CRM_61C9AD01AFA92"]').show();

                }
                else {
                    $('div[data-cid="UF_CRM_1662816497"]').show();
                    $('input[name="UF_CRM_1681060407887"]').val(" ");
                    $('input[name="UF_CRM_1681060407887"]').html(" ");
                    $('input[name="UF_CRM_61C9AD01AFA92"]').val(" ");
                    $('input[name="UF_CRM_61C9AD01AFA92"]').html(" ");
                }
                
                //$('div[data-cid="UF_CRM_6417603D7286F"]').show();
                $('div[data-cid="UF_CRM_1712040814984"]').show();
                $('div[data-cid="UF_CRM_1723022636809"]').show();
                $('div[data-cid="UF_CRM_6609D114673A9"]').show();
                $('div[data-cid="UF_CRM_633588F66C4DF"]').show();
        ...
        if (!me.curInn) {
            ...
            //$('div[data-name="UF_CRM_6417603D7286F"]').addClass('field-is-error');
            $('input[name="UF_CRM_1681060407887"]').addClass('field-is-error');
            $('input[name="UF_CRM_61C9AD01AFA92"]').addClass('field-is-error');
    ...
    CheckFieldInn.prototype.hideFields = function(field) {
        ...
        $('.ui-entity-editor-content-block-click-editable', block).each( function() {
            if ($(this).attr('data-cid') != field) {
                if ($(this).attr('data-cid') != "UF_CRM_633588F66C4DF") {
                    $(this).hide();
                }
            }
        }); 
        ...
        //$('div[data-cid="UF_CRM_633588F66C4DF"]').hide();
    }
