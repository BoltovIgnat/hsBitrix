...
/*                    const address = "<br />" + 'Адрес: '+ me.parameters.address || '';
                    ...
                    const onecDocsLink = "<br /><br /><a href='/crm/company/details/"+me.parameters.companyID+"/?tab_onecDocsTab=Y'>Закупки по 1с</a>"
                    var child = BX.create(
                        "div",
                        {
                            props:
                                ...
                                BX.create(
                                    "div",
                                    {
                                        ...
                                        html: 'ИНН: ' + me.RQ_INN + revenue + ''
                                            + age + owners + linked + ''
                                            + countStaff + capital + link + colDeals + projectsActive + projectsSuccess + onecDocsLink
                                    }
                                )
                            ]
                        }
