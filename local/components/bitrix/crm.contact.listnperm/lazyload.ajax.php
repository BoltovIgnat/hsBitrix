...
$ajaxLoaderParams = array(
	'url' => '/local/components/bitrix/crm.contact.listnperm/lazyload.ajax.php?&site='.SITE_ID.'&'.bitrix_sessid_get(),
	'method' => 'POST',
	'dataType' => 'ajax',
...
$APPLICATION->IncludeComponent('bitrix:crm.contact.listnperm',
